...
class DisallowLogicInBladeSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === T_INLINE_HTML &&
            ...
            (stripos($tokens[$stackPtr]['content'],'@if') !== FALSE ||
            stripos($tokens[$stackPtr]['content'],'@elseif') !== FALSE ||
            stripos($tokens[$stackPtr]['content'],'@endif') !== FALSE ||
            stripos($tokens[$stackPtr]['content'],'@else') !== FALSE)
